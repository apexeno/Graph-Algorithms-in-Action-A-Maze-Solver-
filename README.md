...
# Week 1: 
Get comfortable with C++ syntax, array/string patterns, Big-O analysis, and bit manipulation.
# Week 2: 
Master the STL containers and core algorithms — sorting, binary search, recursion, and backtracking.
